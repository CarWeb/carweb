...
<body class="body_bg">
	<div class="whole">
		...
		<form id="form1" action="/maven02/login/insertValue"  method="get" class="form_box">
			...
			<div class="finish_box" id="finish_box">
				<input class="finish_btn" type="button" id="finish" onclick="insert()" value="insert" />
	...
	<script>
		function insert(){
			...
			var url = "http://localhost:8080/maven02/login/insertValue";		  
			$.ajax({
